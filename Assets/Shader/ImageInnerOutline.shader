Shader "Custom/ImageInnerOutline"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata i)
            {
                ...
                o.lu = o.uv + half2(-1, 1) * _MainTex_TexelSize.xy * _OutlineWidth;
                o.ru = o.uv + half2(1, 1) * _MainTex_TexelSize.xy * _OutlineWidth;
                o.ld = o.uv + half2(-1, -1) * _MainTex_TexelSize.xy * _OutlineWidth;
                o.rd = o.uv + half2(1, -1) * _MainTex_TexelSize.xy * _OutlineWidth;
                return o;
            }
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float transparent = tex2D(_MainTex, i.left).a * tex2D(_MainTex, i.right).a * tex2D(_MainTex, i.up).a * tex2D(_MainTex, i.down).a
                                    *tex2D(_MainTex, i.lu).a * tex2D(_MainTex, i.ru).a * tex2D(_MainTex, i.ld).a * tex2D(_MainTex, i.rd).a;
